		...
		<div class="widget has-shadow">
			...
			<div class="widget-body">
				...
				<div class="form-group row d-flex align-items-center mb-5">
					...
					<div class="col-md-10">
						<input type="text" class="form-control alias news_category_alias" data-alias-prefix="" name="alias" value="<?= $news['alias'] ?>">
						<small>
							<!-- <code>Bắt buộc</code> -->
						</small>
					</div>
				...
				<div class="form-group row d-flex align-items-center mb-5">
					...
					<div class="col-md-10">
						<div class="custom-control custom-radio styled-radio d-inline-block">
							<input class="custom-control-input" type="radio" name="hot" id="opt-03" <?= !$news['hot'] ? "checked" : "" ?> value="0">
							<label class="custom-control-descfeedback" for="opt-01">Bình thường</label>
						</div>
						&nbsp;
						&nbsp;
						<div class="custom-control custom-radio styled-radio d-inline-block">
							<input class="custom-control-input" type="radio" name="hot" id="opt-04" <?= $news['hot'] ? 'checked' : '' ?> value="1">
