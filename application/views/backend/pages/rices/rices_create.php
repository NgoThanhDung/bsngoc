	...
	<div class="col-12">
		...
		<div class="widget has-shadow">
			...
			<div class="widget-body">
				<?php echo form_open(base_url('admin/rices/create'), ['class'=>'form-horizontal create-news-form']); ?>
				...
				<div class="form-group row d-flex align-items-center mb-5">
					...
					<div class="col-md-10">
						<textarea type="text" class="form-control news_category_name" name="caption" value="<?= set_value('news_caption') ?>" autocomplete="off"></textarea>
						<small>
							<code>Nên có</code>
						</small>
					</div>
				...
				<div class="form-group row d-flex align-items-center mb-5">
					...
					<div class="col-lg-10">
						<div class="form-group">
							<div>
								<img class="ricesimage" src="" alt="" style="display: block; max-width: 100%">
							</div>
							<br>
