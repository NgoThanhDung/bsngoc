	...
	<div class="col-12">
		...
		<div class="widget has-shadow">
			...
			<div class="widget-body">
				...
				<!-- ======================= -->
				<div class="form-group row d-flex align-items-center mb-5">
					<label class="col-md-3 form-control-label d-flex justify-content-md-end">Tên Bác sĩ</label>
					<div class="col-md-7">
						<input required type="text" class="form-control" name="doctor_name" value="<?= $contact['doctor_name'] ?>" autocomplete="off">
					</div>
				</div>

				<!-- ======================= -->
				<div class="form-group row d-flex align-items-center mb-5">
					<label class="col-md-3 form-control-label d-flex justify-content-md-end">Tên miền</label>
					<div class="col-md-7">
						<input required type="text" class="form-control" name="domain" value="<?= $contact['domain'] ?>" autocomplete="off">
					</div>
				</div>
				<!-- ======================= -->
				<div class="form-group row d-flex align-items-center mb-5">
				...
				<!-- ======================= -->
				<div class="form-group row d-flex align-items-center mb-5">
					<label class="col-md-3 form-control-label d-flex justify-content-md-end">Thời gian làm việc</label>
					<div class="col-md-7">
						<input required type="text" class="form-control" name="time_work" value="<?= $contact['time_work'] ?>" autocomplete="off">
					</div>
				</div>
				<!-- ======================= -->
				<div class="form-group row d-flex align-items-center mb-5">
					<label class="col-md-3 form-control-label d-flex justify-content-md-end">Slogan</label>
					<div class="col-md-7">
						<textarea class="form-control" name="slogan"><?= $contact['slogan'] ?></textarea>
					</div>
				</div>
				<!-- ======================= -->
				<div class="em-separator separator-dashed"></div>
