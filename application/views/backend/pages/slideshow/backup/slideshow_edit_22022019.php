		...
		<div class="widget has-shadow">
			...
			<div class="widget-body">
				<?php echo form_open(base_url('admin/slideshow/update'), ['class'=>'form-horizontal create-slideshow-form']); ?>
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-md-10">
							<input type="text" class="form-control name" name="name" value="<?= $slide['name'] ?>" autocomplete="off">
							<small>
          ...
          <!-- ======================= -->
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<label class="col-md-2 form-control-label d-flex justify-content-md-end">Đường dẫn</label>
						...
						<div class="col-lg-10">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" autocomplete="off" name="link" value="<?= $slide['link'] ?>">
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-10">
							<div class="form-group">
								<div>
									<img class="slideimage" src="<?= $slide['image'] ?>" alt="" style="display: block; max-width: 100%">
								</div>
								<br>
								<div class="input-group">
									<span class="input-group-btn">
									...
									<input type="text" class="form-control" name="image" id="slideimage" value="<?= $slide['image'] ?>" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-10 offset-md-2 text-right">
						<button class="btn btn-gradient-02" type="submit">Cập nhật slide</button>
					</div>
					<!-- ======================= -->
				<?php echo form_close(); ?>
			</div>
