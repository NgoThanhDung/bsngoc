...
<body>
  ...
  <div class="container">
    ...
    <div class="body">
      <p>Xin chào quý khách <?= $email_data['firstname'] ?>,</p>
      <p>Chúng tôi gửi email này để giúp quý khách xác thực tài khoản trước khi đăng nhập. Hãy truy cập vào liên kết phía dưới để xác thực tài khoản:</p>
      <p><a href="<?= base_url('xac-thuc/'.$email_data['token']) ?>">Xác thực tài khoản</a></p>
    </div>
    <div class="footer">
      <p>
