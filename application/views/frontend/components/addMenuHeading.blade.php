...
<script type="text/javascript">
    function myFunction() {
        var x = document.getElementById("content-collapse");
        if (x.innerHTML === "Hide") {
            x.innerHTML = "Show";
    ...
    function setList() {
        ...
        $(".single_page_content h2, .single_page_content h3, .single_page_content h4").each(function() {
